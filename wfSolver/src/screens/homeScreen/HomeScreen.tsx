    ...
    <div className="flex min-h-screen">
      ...
      >
        ...
        <button
          ...
          className="absolute top-4 right-0 transform translate-x-1/2 bg-gray-700 hover:bg-gray-600 rounded-full p-2 transition-colors"
        >
          <svg
        ...
        <div className="pt-16 px-3 space-y-2">
          ...
          >
            ...
            {sidebarOpen && <span>Saved Workflows</span>}
          </button>
          ...
          >
            ...
            {sidebarOpen && <span>Simulation Results</span>}
          </button>
        </div>
      </div>
      ...
      <div className={`flex-1 transition-all duration-300 ${sidebarOpen ? 'ml-64' : 'ml-16'}`}>
        <div className="max-w-4xl mx-auto p-6 space-y-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-700 mb-6 text-center">
              Create a random workflow using different generation approaches for realistic workflow
              structures.
            </p>
              ...
              <div className="text-xs text-gray-600 bg-blue-50 p-3 rounded-md">
                ...
                {generatorType === 'workflow' && (
                  <p>
                    ...
                    endpoints, and visual optimization. Used gamma distribution for task durations,
                    and transfer time between tasks.
                  </p>
                )}
                {generatorType === 'preset' && (
                  <p>
                    Uses pre-configured settings optimized for common workflow patterns and research
                    scenarios.
                  </p>
                )}
              </div>
